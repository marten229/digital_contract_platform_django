...
class ContractActivity(models.Model):
    ...
    ACTION_CHOICES = (
        ...
        ('blockchain_withdraw_success', 'Vertragsgelder erfolgreich abgehoben'),
        ('blockchain_withdraw', 'Blockchain-Geldabhebung vorbereitet'),
        ('blockchain_view', 'Blockchain Vertragsinteraktion abgerufen'),
        ('delivery_confirmed', 'Lieferbestätigung vorbereitet für MetaMask'),
        ('delivery_rejected', 'Lieferung abgelehnt'),
        ('tracking_prepare', 'Tracking-Nummer vorbereitet für Blockchain'),
        ('tracking_blockchain_success', 'Tracking-Nummer erfolgreich auf Blockchain hinterlegt'),
        ('tracking_error', 'Fehler bei Tracking-Verarbeitung'),
        ('blockchain_published', 'Vertrag auf Blockchain veröffentlicht'),
        ('blockchain', 'Blockchain-Transaktion durchgeführt'),
        ('blockchain_error', 'Blockchain-Fehler aufgetreten'),
        ('blockchain_sign_view', 'Blockchain-Bestätigungsseite aufgerufen'),
        ('blockchain_complete', 'Blockchain-Vertrag abgeschlossen'),
        ('blockchain_complete_view', 'Blockchain-Abschlussseite aufgerufen'),
        ('blockchain_void', 'Blockchain-Vertrag storniert'),
