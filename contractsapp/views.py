    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.success(request, 'Vertrag wurde hochgeladen und Ihr Partner wurde per E-Mail eingeladen.')
            except Exception as e:
                messages.warning(request, f'Vertrag wurde hochgeladen, aber die Einladungs-E-Mail konnte nicht gesendet werden. Fehler: {str(e)}')
